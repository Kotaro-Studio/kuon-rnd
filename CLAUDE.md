...
| P4 | フリーランス音楽家 | 25-50 | ツール統合、認定、発表機会、成長可視化 | Pro+認定 | 5万-15万人 |
| P5 | 社会人リスタート層 | 30-60 | もう一度本気で音楽に向き合う | Pro（一部認定） | 50万-200万人（本気層） |
...
| Kuon 認定プラン（維持費） | ¥1,980/月 | 700 人 | ¥1,386,000 |
| 認定試験受験料 | 平均 ¥14,800 | 300 件/月 | ¥4,440,000 |
| 教室プラン（個人教室・インバウンド） | 平均 ¥7,480/月 | 120 教室 | ¥897,600 |
| 単発コンテンツ・マスタークラス販売 | — | — | ¥500,000 |
| **合計 MRR** | | | **¥23,213,600** |

保守的シナリオ（学生 1.2 万、プロ 5 千、認定維持 400、試験 200 件、
教室 80）でも MRR ¥15.3M。バッファ付きで ¥18M 達成可能。

### 37.5 認定制度の二重収益構造

認定制度は **試験受験料（フロー）＋ 認定維持費（ストック）** の二重構造
にする。これによりマイク販売が抜けた穴を埋めるコアエンジンとなる。

認定は離脱抑止装置としても機能する。認定を持つ人は Kuon から離れにくく、
解約率を下げる。認定を持つ事自体がブランドの信頼プルーフとして機能する。

**具体的な試験範囲、段階別価格、更新サイクル、認定者特典などは次の
セッションで詳細設計する。次セッションの最優先議題。**

### 37.6 ロードマップ（個人主軸・マイク無し）

| Phase | 期間 | 主なアクション | MRR 目安 |
|-------|------|--------------|---------|
| 1 | 1-3ヶ月 | 学生・プロプラン決済実装、認定制度骨格設計、YouTube 週次化 | ¥300K |
| 2 | 4-6ヶ月 | Bronze 認定試験開始、学生プラン獲得本格化 | ¥1-1.5M |
| 3 | 7-12ヶ月 | Silver 認定開始、体系コンテンツ充実、初期認定者事例公開 | ¥4-5M |
| 4 | 12-18ヶ月 | Gold 認定、教室プランのインバウンド受付開始 | ¥10-12M |
| 5 | 18-24ヶ月 | Platinum 認定、Kuon 音楽祭・楽曲マーケット等で収益多層化 | ¥18M 超え |
...
- Kuon 認定の権威付け（初期 Platinum 認定者として参加）
...
フォーム」**。ツール＋学習＋認定＋コミュニティ＋発表機会を一貫提供。
競合ゼロの空白市場。

### 37.10 次セッションの最優先議題

Kuon 認定制度の具体設計：
- 各段階（Bronze/Silver/Gold/Platinum）の試験範囲
- 受験方式（自動採点・人的評価のハイブリッド）
- 認定の期限と更新サイクル
- 認定取得後の特典（認定アーティスト紹介ページ仕様など）
- 段階別の受験料・維持費
- 不合格者へのフィードバック設計
- 認定ブランドの権威性の作り方
...
**Kuon 認定制度の具体設計**（§37.10 参照）。試験範囲・受験方式・
価格・維持費・認定者特典・権威性の作り方を詰め切る。これが決まると
個人主軸の収益モデルのコアエンジンが確定する。
