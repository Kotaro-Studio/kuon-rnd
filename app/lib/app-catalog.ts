...
export const APP_CATALOG: CatalogApp[] = [
  ...
  {
    // 2026-04-27 サブスクモデルへ移行: 旧 ¥1,980 買い切り → Concerto プラン解禁
    id: 'itadaki',
    name: { ja: 'KUON ITADAKI', en: 'KUON ITADAKI', es: 'KUON ITADAKI' },
    tagline: { ja: 'アンプ歪みの「頂」復元 (エルミート補間)', en: 'Asymmetrical declipper · Hermite spline reconstruction', es: 'Reparación de clipping asimétrico' },
    href: '/itadaki-lp',
    launchHref: '/itadaki',
    emoji: '⛰',
    category: 'recording',
  ...
  // 2026-04-30 アプリ一覧から非掲載 (準備段階のため): ANALOG TOOLS / SOUNDMAP / EVENTS / GALLERY
  // URL ルート (/analog-tools, /soundmap, /events, /gallery) は残存するが、
  // APP_CATALOG から除外することで /audio-apps · /mypage · ホーム新着には表示されない。
  // 準備整い次第、コメント解除で復活可能。
  // {
  //   id: 'analog-tools',
  ...
  //   href: '/analog-tools', launchHref: '/analog-tools', emoji: '📻',
  //   category: 'analysis', noLogin: true, serverApp: false, quotaKey: null,
  //   badges: [], minPlan: 'free',
  // },
  ...
  //   href: '/soundmap', launchHref: '/soundmap', emoji: '🌍',
  //   category: 'sharing', noLogin: false, serverApp: false, quotaKey: null,
  //   badges: [], minPlan: 'free-with-login',
  // },
  // {
  //   id: 'events',
  ...
  //   href: '/events-lp', launchHref: '/events', emoji: '🎪',
  //   category: 'sharing', noLogin: true, serverApp: false, quotaKey: null,
  //   badges: [], minPlan: 'free',
  // },
  // {
  //   id: 'gallery',
  ...
  //   href: '/gallery', launchHref: '/gallery', emoji: '🖼',
  //   category: 'sharing', noLogin: true, serverApp: false, quotaKey: null,
  //   badges: [], minPlan: 'free',
  // },
  ...
  },
  {
    ...
    tagline: { ja: 'ソルフェジオ周波数サイン波プレーヤー (Curanz Sounds 商品)', en: 'Solfeggio frequency sine wave player (Curanz Sounds product)', es: 'Reproductor de frecuencias solfeggio' },
    href: '/frequency-lp',
