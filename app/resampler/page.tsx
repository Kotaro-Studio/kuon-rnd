...
// ─────────────────────────────────────────────
const T = {
  pageTitle: { ja: 'KUON\u00A0RESAMPLER', en: 'KUON\u00A0RESAMPLER', es: 'KUON\u00A0RESAMPLER' } as L3,
  pageSubtitle: {
  ...
  lblName: { ja: 'ファイル名', en: 'File Name', es: 'Nombre' } as L3,
  lblFormat: { ja: 'サンプルレート', en: 'Sample Rate', es: 'Frecuencia' } as L3,
  lblChannels: { ja: 'チャンネル', en: 'Channels', es: 'Canales' } as L3,
  lblDuration: { ja: '再生時間', en: 'Duration', es: 'Duración' } as L3,
  lblSize: { ja: 'ファイルサイズ', en: 'File Size', es: 'Tamaño' } as L3,
  targetRate: { ja: '出力サンプルレート', en: 'Output Sample Rate', es: 'Frecuencia de salida' } as L3,
  quality: { ja: 'フィルタ品質', en: 'Filter Quality', es: 'Calidad del filtro' } as L3,
