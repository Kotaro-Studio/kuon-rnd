...
const DESC =
  '音楽レッスンの録音を AI が自動で書き起こし・要約・アクション項目化。話者を教師/生徒に推定、音楽専門用語を自動認識、6 言語翻訳、Markdown/PDF/SRT 出力。Workers AI Whisper-large-v3-turbo + Llama 3.3 70B + M2M100。Prelude プランから月 20 回利用可能。';
