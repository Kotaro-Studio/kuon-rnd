...
function SubscriptionPreview({ lang }: { lang: Lang }) {
  ...
  const plans: PlanCard[] = [
    ...
    },
    {
      ...
      accent: '#0284c7',
      features: [
        { ja: '29 アプリが無制限 (Free から +16)', en: '29 apps unlimited (+16 from Free)', es: '29 apps ilimitadas (+16 de Free)', ko: '29개 앱 무제한 (Free + 16)', pt: '29 apps ilimitados (+16 do Free)', de: '29 Apps unbegrenzt (+16 von Free)' },
    ...
    },
    {
      ...
      accent: '#7c3aed',
      features: [
        { ja: '全 33 アプリが無制限 (業務系 +4)', en: 'All 33 apps unlimited (+4 pro)', es: 'Las 33 apps ilimitadas (+4 pro)', ko: '전체 33개 앱 무제한 (+4 프로)', pt: 'Todos 33 apps ilimitados (+4 pro)', de: 'Alle 33 Apps unbegrenzt (+4 Pro)' },
