...
export default function LessonM4L04() {
  const { lang } = useLang();
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          <div style={{ fontFamily: sans, fontSize: '0.78rem', color: INK_FAINT, letterSpacing: '0.04em' }}>
            {t({ ja: 'M4 機能和声 · Lesson 4', en: 'M4 Diatonic Harmony · Lesson 4', es: 'M4 Armonía diatónica · Lección 4', ko: 'M4 기능 화성 · 레슨 4', pt: 'M4 Harmonia diatônica · Lição 4', de: 'M4 Diatonische Harmonik · Lektion 4' }, lang)}
          </div>
