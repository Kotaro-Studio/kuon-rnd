...
/**
 * /theory/m1/l40 — M1-40「三和音の基本形と転回形」
 * =========================================================
 * 三和音 (triad) は和声の構成単位。同じ 3 音でもバスを変えることで色が変わる。
 *
 * OMT v2 マッピング:
 *   - Part I 第 17 章 (Triads) + 第 19 章 (Inversion and Figured Bass) を統合
 *   - 60 レッスン展開で M1-40 〜 M1-49 のブロックに位置
 *   - 前提: M1-35 〜 M1-39 (音程の種類・第 16 章 Intervals) を先に学ぶ
 *
...
export default function LessonM1L40() {
  const { lang } = useLang();
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          <div style={{ fontFamily: sans, fontSize: '0.78rem', color: INK_FAINT, letterSpacing: '0.04em' }}>
            {t({ ja: 'M1 楽典基礎 · Lesson 40', en: 'M1 Fundamentals · Lesson 40', es: 'M1 Fundamentos · Lección 40', ko: 'M1 악전 기초 · 레슨 40', pt: 'M1 Fundamentos · Lição 40', de: 'M1 Grundlagen · Lektion 40' }, lang)}
          </div>
