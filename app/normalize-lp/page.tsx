...
const content = {
  ja: {
    ...
    featuresDesc: 'ファイルをドロップして、目的を選ぶだけ。複雑なDAWは不要です。すべての処理はあなたのブラウザの中だけで完結します。データが外部に送信されることは一切ありません。',
    feat1Title: 'ピュア・ノーマライズ',
    feat1Desc: '波形のダイナミクスを完全に保ったまま、最大ピークを -0.1dB に揃えます。音楽編集の最初の一手に。',
    feat1Mode: 'PEAK MODE',
    feat2Title: 'ラウドネス最適化',
    ...
    magicTitle: '3つのスイッチが、\n録音を変える。',
    magicDesc: '処理は組み合わせ自由。すべてONにしても、1つだけでも。最適な組み合わせを探す時間そのものが、エンジニアリングの醍醐味です。',
    switch1Name: '位相反転',
    switch1Desc: '録音時の逆相を正相に補正。合唱マイクセッティングで特に効果的。',
    switch2Name: '朝比奈シグネチャー EQ',
    switch2Desc: '空音マイクの録音に最適化された、ほんのわずかな隠し味のEQ処理。',
    switch3Name: 'ナチュラル・ホールリバーブ',
    switch3Desc: 'ウェット感わずか6%。気づかないほど微小で、しかし確実に空間をリッチにする余韻。',
    micLabel: 'THE KEY',
    micTitle: 'このアプリを使うための、\nたった一つの条件。',
    micDesc1: '空音開発の無指向性マイクロフォンをご購入いただくと、製品と同梱、またはメールにてパスワードをお届けします。そのパスワードを入力するだけで、このアプリが即座に解放されます。',
    ...
    exclusiveDesc: 'KUON NORMALIZEは、空音開発のマイクロフォンとセットでのみ入手できます。これは意図的な決定です。マイクを持つ人だけが、その音を完成させるツールを手にできる。それが空音開発の哲学です。',
    ctaLabel: 'GET STARTED',
    ctaTitle: 'マイクを手に入れて、\nこのアプリを解放する。',
    ctaDesc: 'マイクロフォンのご購入後、パスワードをメールにてお送りします。',
    ctaBtn: 'マイクロフォンを購入する',
    ctaBtnSub: 'kotarohattori.com にて販売中 — ¥13,900',
    ctaAlready: 'すでにパスワードをお持ちの方',
    ctaAppLink: 'アプリを開く →',
    footerCopy: '© 2025 空音開発 Kuon R&D. All rights reserved.',
    privacy: 'すべての音声処理はブラウザ内で完結。データの外部送信は一切行いません。',
  },
  en: {
    toggleBtn: '日本語',
    badge: 'MICROPHONE OWNERS EXCLUSIVE',
