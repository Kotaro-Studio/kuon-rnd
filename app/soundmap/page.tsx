...
const T: Record<string, L3> = {
  ...
  recBy: { ja: '録音: ', en: 'Rec: ', es: 'Grab: ', ko: '녹음: ' },
  stopBtn: { ja: '停止', en: 'Stop', es: 'Detener', ko: '중지' },
  ...
  submitDesc: {
    ...
    ko: '지구의 소리 지도에서 세계와 녹음을 공유하세요.\n필드 녹음, 주변음, 자연음 — 당신만 들은 소리를 세계와 공유하세요.',
  },
  fieldName: { ja: 'お名前', en: 'Your Name', es: 'Tu Nombre', ko: '이름' },
  fieldEmail: { ja: 'メールアドレス', en: 'Email', es: 'Correo Electrónico', ko: '이메일' },
  fieldLocation: { ja: '録音場所', en: 'Recording Location', es: 'Ubicación de Grabación', ko: '녹음 위치' },
  fieldLocationHint: { ja: '例: 北海道広尾町 フンベの滝', en: 'e.g. Trinity Beach, Queensland', es: 'ej. Playa Trinity, Queensland', ko: '예: 호주 퀸즐랜드 트리니티 비치' },
  fieldDescription: { ja: '録音の説明', en: 'Description', es: 'Descripción', ko: '설명' },
  fieldDescriptionHint: { ja: 'どんな音が聴こえますか？', en: 'What sounds can you hear?', es: '¿Qué sonidos puedes escuchar?', ko: '어떤 소리가 들리나요?' },
  fieldCoords: { ja: '座標（緯度, 経度）', en: 'Coordinates (Lat, Lng)', es: 'Coordenadas (Lat, Lng)', ko: '좌표 (위도, 경도)' },
  fieldCoordsHint: { ja: '地図をクリックして座標を取得できます', en: 'Click the map to get coordinates', es: 'Haz clic en el mapa para obtener coordenadas', ko: '좌표를 얻기 위해 지도를 클릭하세요' },
  fieldFile: { ja: 'MP3 ファイル（20MB以下）', en: 'MP3 File (max 20MB)', es: 'Archivo MP3 (máx. 20MB)', ko: 'MP3 파일 (최대 20MB)' },
  fieldMic: { ja: '使用マイク（任意）', en: 'Microphone Used (optional)', es: 'Micrófono Usado (opcional)', ko: '사용된 마이크 (선택사항)' },
  fieldUrl: { ja: 'あなたのサイト / SNS（任意）', en: 'Your Website / SNS (optional)', es: 'Tu Sitio Web / SNS (opcional)', ko: '귀하의 웹사이트 / SNS (선택사항)' },
  fieldPassword: { ja: '投稿パスワード', en: 'Submission Password', es: 'Contraseña de Envío', ko: '게시 비밀번호' },
  fieldPasswordHint: { ja: '現在はマイクご購入者のみ投稿いただけます', en: 'Currently limited to microphone purchasers', es: 'Actualmente limitado a compradores de micrófonos', ko: '현재 마이크 구매자만 게시 가능합니다' },
  submit: { ja: '投稿する', en: 'Submit', es: 'Enviar', ko: '제출' },
  submitting: { ja: '送信中...', en: 'Submitting...', es: 'Enviando...', ko: '제출 중...' },
  submitSuccess: { ja: '投稿ありがとうございます！確認後に掲載いたします。', en: 'Thank you! Your recording will be published after review.', es: '¡Gracias! Tu grabación se publicará después de la revisión.', ko: '감사합니다! 검토 후 녹음을 게시하겠습니다.' },
  submitError: { ja: '送信に失敗しました。もう一度お試しください。', en: 'Submission failed. Please try again.', es: 'Error al enviar. Inténtalo de nuevo.', ko: '제출 실패. 다시 시도하세요.' },
  mapClickSet: { ja: '座標をセットしました', en: 'Coordinates set', es: 'Coordenadas establecidas', ko: '좌표가 설정되었습니다' },
};
